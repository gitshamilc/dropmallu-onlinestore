/* ═══════════════════════════════════════════════════════════════
   DROPMALLU — Dedicated Product Detail Page Hydrator
   ═══════════════════════════════════════════════════════════════ */
...
function hydrateMetadata(p) {
  const canonicalUrl = `https://dropmallu.xyz/product/${slugify(p.name)}`;
  
  // Set title
  document.title = `${p.name} — Buy Premium ${p.category.charAt(0).toUpperCase() + p.category.slice(1)} | DROPMALLU`;
  ...
  if (ogTitle) ogTitle.content = `${p.name} — DROPMALLU`;
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `https://dropmallu.xyz/category/${p.category}`
      },
      {
        "@type": "ListItem",
        "position": 3,
